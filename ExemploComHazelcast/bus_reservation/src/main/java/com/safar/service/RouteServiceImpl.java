...
public class RouteServiceImpl implements RouteService{
	...
	@Autowired
	private IMap<Long, Route> routeCache;
	...
	public Route addRoute(Route route,String key) throws RouteException, AdminException {
	    ...
	    routeCache.put(savedRoute.getRouteID(), savedRoute);
	...
	public List<Route> viewAllRoute() throws RouteException {
	    ...
	    if (routes.isEmpty()) {
	        ...
	        for (Route route : routes) {
	            routeCache.put(route.getRouteID(), route);
	        }
	        return routes;
	    }
	}
	...
	public Route viewRoute(Long routeId) throws RouteException {
	    Route cachedRoute = routeCache.get(routeId);
	    ...
	    if (opt.isPresent()) {
	        ...
	        throw new RouteException("There is no route present with this routeId: " + routeId);
	    }
	}
	...
	@Override
	public Route deleteRoute(Long routeID,String key) throws RouteException, AdminException {
