...
public class FeedbackController {
	...
	public ResponseEntity<Feedback> deleteFeedback(@PathVariable("id") Long feedbackId,@RequestParam(required = false) String key) throws FeedBackException, UserException {
	...
	public ResponseEntity<Feedback> viewFeedback(@PathVariable("id") Long ID) throws FeedBackException {
