...
public class ReservationController {
    ...
    public ResponseEntity<Reservation> updateReservation(@Valid @RequestBody ReservationDTO dto, @RequestParam(required = false) String key, @PathVariable Long rid) throws ReservationException{
    ...
    public ResponseEntity<Reservation> deleteReservation( @RequestParam(required = false) String key, @PathVariable Long rid) throws ReservationException{
    ...
    public ResponseEntity<Reservation> viewReservationById(@PathVariable Long rid, @RequestParam(required = false) String key) throws ReservationException {
    ...
    public ResponseEntity<List<Reservation>> viewReservationsByUserId(@PathVariable Long uid, @RequestParam(required = false) String key) throws ReservationException{
