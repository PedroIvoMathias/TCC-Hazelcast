...
public class RouteController {
	...
	public ResponseEntity<Route> getAllRouteByRouteIdHandler( @PathVariable Long routeID) throws RouteException{
	...
	public ResponseEntity<Route> DeleteRoute(@PathVariable Long routeID,@RequestParam(required = false) String key) throws RouteException, AdminException{
